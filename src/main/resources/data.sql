...
(9, 2024, 'Spring', '2023-11-01', '2025-03-30', '2025-03-30', '2024-01-15', '2024-05-17'),
(10, 2024, 'Fall',  '2023-05-01', '2025-08-30', '2025-08-30', '2024-08-15', '2024-12-17');

insert into user_table (id, name, email, password, type) values
(1, 'david wisneski', 'dwisneski@csumb.edu', '$2a$10$8cjz47bjbR4Mn8GMg9IZx.vyjhLXR/SKKMSZ9.mP9vpMu0ssKi8GW', 'INSTRUCTOR'),
